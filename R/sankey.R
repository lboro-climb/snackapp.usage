#' create_sankey
#' 
#' @description A function to create a sankey diagram
#'
...
create_sankey <- function(data){
  viewed_screen <- data %>%
    ...
    dplyr::mutate(
      ...
      Metric = dplyr::if_else(stringr::word(Metric, sep = "-") == "my", stringr::str_sub(Metric, start = 1, end = 8), stringr::word(Metric, sep = "-")),
